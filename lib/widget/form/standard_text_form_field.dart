...
import '../../core/enum/app_text_theme.dart';
...
class StandardTextFormField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      onTap: () => onTapWidget(context, focusNode: focusNode, onTap: onTap),
      onChanged: onChanged,
      onFieldSubmitted: (value) =>
          onFieldSubmittedWidget(value, onFieldSubmitted: onFieldSubmitted),
    );
  }
}
